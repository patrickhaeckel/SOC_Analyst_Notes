...
- **Buffer settings** — Important for understanding performance impact
...
- The `-p "<ProviderName>"` option means you’re targeting a **single ETW provider**.
