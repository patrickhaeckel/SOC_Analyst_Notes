...
| **userPrincipalName (UPN)** | A modern-style logon name in **email format** (e.g., `bjones@herotransport.local`). Not mandatory, but preferred for simplicity in enterprise environments. |
